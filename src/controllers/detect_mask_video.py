...
def detect_and_predict_mask(frame, faceNet, maskNet):
    ...
    # only make a predictions if at least one faces was detected
    if len(faces) > 0:
...
# load our serialized faces detector model from disk
...
# load the faces mask detector model from disk
...
while True:
    ...
    # loop over the detected faces locations and their corresponding
    # locations
